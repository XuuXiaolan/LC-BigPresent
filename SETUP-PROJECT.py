...
def main():
   ...
   <Project ToolsVersion="Current" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
      ...
      <ItemGroup>
         <AssetBundles Include="../../../UnityProject/Assets/ModAssets/BigPresent/AssetBundles/*" />
         <AssetBundles Remove="../../../UnityProject/Assets/ModAssets/BigPresent/AssetBundles/*.meta" />
         <AssetBundles Remove="../../../UnityProject/Assets/ModAssets/BigPresent/AssetBundles/*.manifest" />
         <AssetBundles Remove="../../../UnityProject/Assets/ModAssets/BigPresent/AssetBundles/AssetBundles" />
      </ItemGroup>
   ...
   fp = open(f'{thisPath}/Plugin/src/BigPresent/BigPresent.csproj.user', 'w')
   fp.write(userFile)
   fp.close()
   print(color.green + f'csproj.user file created at {thisPath}/Plugin/src/BigPresent/BigPresent.csproj.user!')
